...
class resnet_v1_101_fpn_rcnn_l1_focal_test(Symbol):
    ...
    def get_rpn_subnet(self, data, num_anchors,suffix,channel_num=9):
        ...
        rpn_bbox_pred_t = mx.sym.Reshape(data=rpn_bbox_pred, shape=(0, 4 * num_anchors * channel_num, -1), name='rpn_bbox_pred_t_' + suffix)
